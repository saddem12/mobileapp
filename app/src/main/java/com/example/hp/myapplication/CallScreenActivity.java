...
import com.example.hp.myapplication.Request.EndCallRequest;
...
public class CallScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(CallScreenActivity.this);//Creating the RequestQueue
    ...
    private class SinchCallListener implements VideoCallListener {
        ...
        public void onCallEnded(Call call) {
            ...
            String duration = formatTimespan(System.currentTimeMillis() - mCallStart);

            EndCallRequest endCallRequest = new EndCallRequest(meetings_id, duration ,  new Response.Listener<String>() {
                @Override
                    ...
                    try {
                        ...
                        if (success==1) {
                            ...
                            if(jsonObject.getString("message").equals("No user found"))
                                Toast.makeText(CallScreenActivity.this, "User Not Found", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(CallScreenActivity.this, "Bad Response From Server", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    if (error instanceof ServerError)
                        Toast.makeText(CallScreenActivity.this, "Server Error", Toast.LENGTH_SHORT).show();
                    else if (error instanceof TimeoutError)
                        Toast.makeText(CallScreenActivity.this, "Connection Timed Out", Toast.LENGTH_SHORT).show();
                    else if (error instanceof NetworkError)
                        Toast.makeText(CallScreenActivity.this, "Bad Network Connection", Toast.LENGTH_SHORT).show();
                }
            });
            requestQueue.add(endCallRequest);
