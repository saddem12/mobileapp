...
public class SimpleMail {
    ...
    private static final String SMTP_AUTH_USER = "customer.box.webmaster@gmail.com"; //your login username/email
    private static final String SMTP_AUTH_PWD  = "cusbox12"; //password/secret
    ...
    public static void sendEmail(String to, String subject, String msg){
        ...
        String from = "customer.box.webmaster@gmail.com"; //from
